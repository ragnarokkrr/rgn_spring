...
public class ContactsController {
	...
	private ResponseEntity<?> search(String name, int page, Locale locale,
		...
		ContactListVO contactListVO = contactService.findByNameLike(page,
				maxResults, name);
		...
		addSearchMessageToVO(contactListVO, locale,
	...
	private ContactListVO addActionMessageToVO(ContactListVO contactListVO,
		...
		contactListVO.setActionMessage(messageSource.getMessage(messageKey,
				args, null, locale));
	...
	private ContactListVO addSearchMessageToVO(ContactListVO contactListVO,
		...
		contactListVO.setSearchMessage(messageSource.getMessage(message, args,
				null, locale));
		return contactListVO;
	}
